...
namespace Force.Crc32
{
    ...
    {
#if !NET20
        internal static readonly ConcurrentDictionary<uint, uint[]> tables;
        static SafeProxy()
        {
            tables = new ConcurrentDictionary<uint, uint[]>();
        }
#endif

        internal static uint[] GetTable(uint poly)
        {
#if NET20
        ...
        static private void Init(uint poly, uint[] table)
        {
